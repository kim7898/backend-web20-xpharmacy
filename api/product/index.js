...
const { createProduct, getAllProduct, getOneProduct, deleteProduct, getBestSeller, getProductByCategory } = require('./controller');
...
router.get("/category", (req, res) => {
    getProductByCategory(req.query.name)
    .then(products => {
